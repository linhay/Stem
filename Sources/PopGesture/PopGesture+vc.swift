...
extension UIViewController {
    ...
    fileprivate static let once: Void = {
        StemRuntime.exchange(selector: #selector(UIViewController.viewWillAppear(_:)),
                             by: #selector(UIViewController.stem_gesture_viewWillAppear(_:)),
                             class: UIViewController.self)
        
        StemRuntime.exchange(selector: #selector(UIViewController.viewWillDisappear(_:)),
                             by: #selector(UIViewController.stem_gesture_viewWillDisappear(_:)),
                             class: UIViewController.self)
        
        StemRuntime.exchange(selector: #selector(UINavigationController.pushViewController(_:animated:)),
